---
title: "Economic Evaluation: ICER, NMB, and Value-Based Pricing"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Economic Evaluation: ICER, NMB, and Value-Based Pricing}
...
A trial-based economic evaluation compares a new DPP-4 inhibitor to metformin monotherapy over 5 years:
...
The intervention falls in the **NE quadrant** (more costly, more effective). Compare the ICER to the Willingness-to-Pay (WTP) threshold:
...
- **Clinical benefit:** 0.02 QALYs per patient (from faster treatment initiation)
...
- HTAIn Methods Guide. Department of Health Research, Ministry of Health & Family Welfare, Government of India.
