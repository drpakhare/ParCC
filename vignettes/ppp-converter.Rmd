...
At ₹11,60,000 the drug **exceeds 3× GDP per capita** and is flagged red — not cost-effective by WHO-CHOICE criteria at this price.

### Implications for Pricing

The PPP analysis suggests that a price of ₹11,60,000 is the PPP-equivalent economic burden. But even this is above the WTP threshold. A price negotiation should target below ₹5,63,250 (3× GDP/capita) to be considered cost-effective, or below ₹1,87,750 (1× GDP/capita) to be highly cost-effective.
...
2. **WHO-CHOICE thresholds are guides, not rules.** Many countries now use empirical thresholds (UK: £20,000–30,000/QALY; India: 1× GDP/capita per HTAIn guidelines). ParCC shows the WHO-CHOICE thresholds as a starting point.
